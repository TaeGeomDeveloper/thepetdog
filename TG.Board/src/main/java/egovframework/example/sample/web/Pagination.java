...
public class Pagination {
    ...
    public static PageInfoVO getPageInfo(int currentPage, int listCount) {
        ...
        pi = new PageInfoVO(currentPage, listCount, pageLimit, maxPage, startPage, endPage, boardLimit);
