				...
				<li class="nav-link">
							...
							<c:when test="${member != null}">
	                            ...
	                            <span class="text nav-text">TEST</span>
									...
									<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
										<li><a class="dropdown-item" href="${contextPath}/Notice.do"><span class="text nav-text">게시글</span></a></li>
										<li><a class="dropdown-item" href="${contextPath}/PatList.do"><span class="text nav-text">회원의 애완동물</span></a></li>
									</ul>
					...
					<c:choose>
							<c:when test="${member != null}">
	                            ...
	                            <span class="text nav-text">TEST</span>
									...
									<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
										<li><a class="dropdown-item" href="${contextPath}/myPage.do"><span
					...
					<li class="nav-link">
                        <!-- <a href="#">
						  ...
						  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						    <li><a class="dropdown-item" href="${contextPath}/board.do"><span class="text nav-text">미니 게시판</span></a></li>
						    <li><a class="dropdown-item" href="${contextPath}/JVC.do"><span
