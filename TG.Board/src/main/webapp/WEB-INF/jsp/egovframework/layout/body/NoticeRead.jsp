			...
			<div class="d-flex justify-content-center" style="text-align: center; ">
                <table class="table align-middle" style="margin-top: 30px;  border: 5px solid #f7a063;">
                    ...
                    <tr style="margin: auto">
                        ...
                        <td><a href="${contextPath}/Notice/download.do?nb_seq=${notice.nb_seq}&token=on">
                            ${notice.nb_originFileName}</a></td>
                       <%--  <td>${notice.nb_downloadCount}</td> --%>
                        <c:if test="${member.id == notice.nb_id}">
                            <td><a href="${contextPath}/Notice/viewUpdatePage.do?nb_seq=${notice.nb_seq}">
                                <button class="button3">수정</button>
                            </a></td>
                            <td><a href="${contextPath}/Notice/delete.do?nb_seq=${notice.nb_seq}">
